module.exports = {
    ...
    Discord: {
        verifiedRole: "1259963837013168189", // —— Role that will be added to the user when they verify their account.
